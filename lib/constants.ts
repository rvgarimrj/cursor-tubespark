...
export const CONTENT_STYLES = [
  { value: 'educational', label: 'Educational', description: 'Teach and inform your audience' },
  ...
  { value: 'vlog', label: 'Vlog', description: 'Personal vlogs and life updates' },
  { value: 'tutorial', label: 'Tutorial', description: 'Step-by-step how-to guides' },
  { value: 'news', label: 'News', description: 'Current events and updates' },
] as const;

// Duration Preferences
export const DURATION_PREFERENCES = [
  { value: 'shorts', label: 'Shorts (<60s)', description: 'Quick, snackable content' },
  { value: 'medium', label: 'Medium (1-10min)', description: 'Standard video length' },
  { value: 'long', label: 'Long (10min+)', description: 'In-depth, detailed content' },
] as const;
...
export const ERROR_MESSAGES = {
  ...
  youtube: {
    ...
    accessTokenExpired: 'YouTube access token expired. Please reconnect your account',
